...
import com.game.yangtechplatform.utils.CommonUtil;
...
public class HttpUtil {
	...
	public static String http(String urlStr, String method, String postData) {
		...
		try {
			...
			httpConn.setReadTimeout(timeout + timeout);
			...
			long length = responseText.getBytes().length / 1000;
			Constant.AppWebTraficc += length;
